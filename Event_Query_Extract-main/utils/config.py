...
class Config(object):
    def __init__(self):
        self.project_root = ''
        self.data_path = self.project_root + './data/DuEE1.0/pt/'
        self.torch_seed = 39

        # file path
        self.tr_dataset = self.data_path + 'train5.pt'
        self.te_dataset = self.data_path + 'test.pt'
        self.dev_dataset = self.data_path + 'dev5.pt'
        ...
        self.log_file = ''
        self.te_json = ''
        self.dev_json = self.data_path + 'dev5.json'
        self.te_json = self.data_path + 'test.json'
        self.tr_json = self.data_path + 'train5.json'
        self.output_json = self.project_root + 'outputs/output.json'
        self.test_pred_trigger_json = ''
        self.dev_pred_trigger_json = ''
        self.train_file_pt = './data/DuEE1.0/train_pt/train.pt'
        self.dev_file_pt = './data/DuEE1.0/train_pt/dev.pt'
        self.dev_file_json = './data/DuEE1.0/train_pt/dev5.json'
    ...
    def set_tokenizer(self):
        if self.pretrained_weights == 'distilbert':
            ...
            self.tokenizer = BertTokenizer.from_pretrained("./data/chinese_wwm_ext_pytorch")
            ...
            self.tokenizer = BertTokenizer.from_pretrained("./data/roberta_chinese")
        else:
            self.tokenizer = None
