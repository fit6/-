...
class Config(object):
    def __init__(self):
        ...
        # file path
        self.tr_dataset = self.data_path + 'train1.pt'
        self.te_dataset = self.data_path + 'test.pt'
        self.dev_dataset = self.data_path + 'dev1.pt'
        ...
        self.tr_json = self.data_path + 'train1.json'
        self.output_json = self.project_root + 'outputs/output.json'
        self.test_pred_trigger_json = ''
        self.dev_pred_trigger_json = ''
        self.train_file_pt = './data/DuEE1.0/train_pt/train1.pt'
        self.dev_file_pt = './data/DuEE1.0/train_pt/dev1.pt'
        self.dev_file_json = './data/DuEE1.0/train_pt/dev.json'
