...
def eval(model, iterator, fname=None,file_writer=None,epoch=None):
    model.eval()
    ...
    with open('temp', 'w') as fout:
        ...
        file_writer.add_scalar('argument_p_/train', argument_p_, epoch)
        file_writer.add_scalar('argument_r_/train', argument_r_, epoch)
        file_writer.add_scalar('argument_f1_/train', argument_f1_, epoch)
        if fname:
